...
Presenting both options at the cart stage avoids forcing authentication too early, reducing friction and supporting faster conversion for new users.
...
This separation demonstrates early awareness of **error recovery** and alternative paths, rather than assuming a single “happy path” user journey.
